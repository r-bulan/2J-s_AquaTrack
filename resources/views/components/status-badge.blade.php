...
@php
    ...
    $colorClasses = match (strtolower($normalized)) {
        ...
        'confirmed', 'partial', 'in progress', 'rescheduled' => 'bg-blue-50 text-blue-700 border-blue-200',
        ...
        'cancelled', 'failed', 'delivery failed', 'overdue', 'credit', 'expense' => 'bg-rose-50 text-rose-700 border-rose-200',
